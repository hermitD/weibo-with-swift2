...
class WBStatusView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        dispatch_once(&Static.onceToken) { () -> Void in
            Static.topLineBG = UIImage(size: CGSizeMake(1, 3), drawBlock: { (context) -> Void in
            ...
            Static.bottomLineBG = UIImage(size: CGSizeMake(1,3), drawBlock: { (context) -> Void in
                CGContextSetFillColorWithColor(context, UIColor.blackColor().CGColor)
...
class WBStatusToolBarView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.repostButton.setBackgroundImage(UIImage(color: kWBCellHighlightColor), forState: .Highlighted)
        ...
        self.commontButton.setBackgroundImage(UIImage(color: kWBCellHighlightColor), forState: .Highlighted)
        ...
        self.likeButton.setBackgroundImage(UIImage(color: kWBCellHighlightColor), forState: .Highlighted)
